...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "HuggingFace Inference API (Qwen2.5-72B / 7B / Coder-32B) with source-grounded prompting",
    ...
    demo: "https://anson-1-rag-pdf-qa-app-zti4wq.streamlit.app/",
    status: "completed",
  },
  {
    ...
    highlights: [
      ...
      "HuggingFace Inference API (Qwen2.5-72B / 7B / Coder-32B)",
